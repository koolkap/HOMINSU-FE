...
export default function PortalHome() {
  ...
  return <div className="portal-page">
    <section className="portal-hero">
      ...
      <div className="hero-copy"><p className="eyebrow"><span className="eyebrow-dot" />HOMINSU ORIGINALS</p><h1>See the world<br /><em>in 360°.</em></h1><p>From the bottom of the ocean to the edge of space, step into stories made for presence.</p><div className="hero-actions"><a className="button button-cyan" href="/watch/reef"><Play size={16} fill="currentColor" />Watch live</a><a className="button button-ghost" href="#explore">Explore library<ArrowRight size={16} /></a></div></div>
    ...
    <section className="catalog-section" id="explore"><div className="section-heading"><div><p className="eyebrow"><span className="eyebrow-dot cyan" />CURATED FOR YOU</p><h2>Explore <em>immersive</em> worlds</h2></div><a className="text-link" href="/?tab=explore">View all <ChevronRight size={16} /></a></div>
    ...
    <section className="live-strip"><div><p className="eyebrow"><span className="eyebrow-dot red" />HAPPENING NOW</p><h2>Live from everywhere.</h2><p>Join viewers already exploring the planet together.</p></div><div className="live-strip-stat"><Radio size={22} /><strong>{live.reduce((total, content) => total + content.viewerCount, 0).toLocaleString()}</strong><span>viewers online</span></div><a className="button button-dark" href="/?live=true">See live channels<ChevronRight size={16} /></a></section>
...
void (undefined as unknown as MediaContent);
